            ...
            >
              <div className="flex flex-col gap-10">
                <div className="flex items-center ">
                  <div className="relative  px-4">
                    ...
                    >
                      <span className="font-semi text-sm bg-LightNavy hover:bg-LightestNavy rounded-2xl p-2">
                        Select Image
                      </span>
                      <input
                        name="image"
                ...
                <div className="relative h-12 w-96">
                  <label
                    htmlFor=""
                    className={`absolute -top-3 left-3 z-30 bg-bg px-1 text-sm font-semi  ${
                ...
                <div className="relative h-28 w-96">
                  <label
                    htmlFor=""
                    className={`absolute -top-3 left-3 z-30 bg-bg px-1  font-semi text-sm ${
              ...
              <div className="">
                <button
                  disabled={isLoading}
                  type="submit"
                  className="px-8 h-14 text-highlight w-full   duration-200  rounded font-semi hover:bg-LightNavy border border-highlight "
                >
                  {isLoading ? (
